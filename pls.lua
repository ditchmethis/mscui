...
function section:addSlider(title, default, min, max, callback)
	...
	function section:addMultiDropdown(title, list, callback)
		...
		search.Button.MouseButton1Click:Connect(function()
			if search.Button.Rotation == 0 then
				self:updateMultiDropdown(dropdown, selectedItems, list, callback)
			else
				self:updateMultiDropdown(dropdown, selectedItems, nil, callback)
			end
		end)
    ...
    function section:updateMultiDropdown(dropdown, list, callback, selectedItems, title)
        ...
        for i, value in pairs(sortedList or {}) do
            local button = utility:Create("ImageButton", {
                Name = value,
                BackgroundTransparency = 1,
                BorderSizePixel = 0,
            ...
            local function updateText()
                local text = ""
                for item, _ in pairs(selectedItems or {}) do
